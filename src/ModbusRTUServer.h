...
public:
   ...
   */
  int begin(int id, unsigned long baudrate, rs485_serial_config_t config = SERIAL_8N1);
  int begin(RS485Class& rs485, int id, unsigned long baudrate, rs485_serial_config_t config = SERIAL_8N1);
