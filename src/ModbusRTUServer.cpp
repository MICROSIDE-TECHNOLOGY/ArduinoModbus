...
int ModbusRTUServerClass::begin(int id, unsigned long baudrate, rs485_serial_config_t config)
{
...
int ModbusRTUServerClass::begin(RS485Class& rs485, int id, unsigned long baudrate, rs485_serial_config_t config)
{
  _rs485 = &rs485;
